...
**Note on Fluff:** Do not log meta-events like "Context Sync", "Session Resumed", or "System Maintenance" unless an error occurred. Only log meaningful work, decisions, and code changes.
...
- **Standard Conversations:** `google/gemini-3-flash-preview` (Fast, efficient)
- **Complex Tasks / Cron:** `google/gemini-3-pro-preview` (Reasoning, deep analysis)
